      ...
      with gr.Column():
        ...
        with gr.Row():
          with gr.Column(scale=3):
                    dataset = gr.Examples(examples=os.path.join(scripts.basedir(), "extensions/sd-webui-depth-lib/maps"), inputs=[png_input_area],examples_per_page=24,label="Depth Maps")
